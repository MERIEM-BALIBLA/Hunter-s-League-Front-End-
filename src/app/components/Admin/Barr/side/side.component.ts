...
@Component({
  ...
  template: `
  <aside class=" inset-y-0 left-0 bg-white shadow-md h-screen w-60">
    <div class=" h-full">
      <div class="flex-grow">
        ...
        <div class="p-4">
          <ul class="space-y-1">
            <li>
              <a  
                routerLink="/dash" routerLinkActive="active"
            ...
            <li>
              <a 
                routerLink="/competitions" routerLinkActive="active" 
                class="flex bg-white hover:bg-yellow-50 rounded-xl font-bold text-sm text-gray-900 py-3 px-4">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" class="text-lg mr-4" viewBox="0 0 16 16">
            ...
            <li>
              <a
                routerLink="/species" routerLinkActive="active" 
                class="flex bg-white hover:bg-yellow-50 rounded-xl font-bold text-sm text-gray-900 py-3 px-4">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" class="text-lg mr-4" viewBox="0 0 16 16">
